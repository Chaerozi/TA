  ...
  Tambah User
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[1fr_365px] gap-4 items-start w-full">
        ...
        <div className="space-y-4 h-full">
          ...
          {/* LINE CHART */}
<div
  className="w-full bg-white rounded-[12px] border border-slate-200 flex flex-col"
  style={{ height: "300px", padding: "20px", gap: "10px" }}
>
  ...
  {/* CHART AREA — flex-1 agar mengisi sisa height setelah header */}
...
>
  ...
  <path d="M21 21l-4.35-4.35" />
          ...
          {/* ================= MODAL TAMBAH USER ================= */}
{openModal && (
  <div className="fixed inset-0 bg-black/10 flex items-center justify-center z-[999]">

    <div className="w-[500px] bg-white rounded-[16px] p-6 shadow-[0_20px_80px_rgba(0,0,0,0.18)] relative">

      <button
        onClick={() => setOpenModal(false)}
        className="absolute top-4 right-4 w-8 h-8 flex items-center justify-center bg-gray-100 rounded-full hover:bg-gray-200 transition"
      >
        ✕
      </button>
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <select className="w-full h-[44px] px-4 rounded-[12px] border border-gray-200 text-[13px] text-gray-600 outline-none focus:border-blue-500">
  ...
  <option>Unit C</option>
        ...
        <div>
          ...
          <input
            ...
            className="w-full h-[44px] px-4 rounded-[12px] border border-gray-200 text-[13px] outline-none"
          />
        </div>
        ...
        <button
          ...
          className="w-full h-[48px] rounded-[14px] text-white text-[15px] font-medium bg-gradient-to-r from-[#0096FF] via-[#60A5FA] to-[#0022FF] shadow-[0_8px_20px_rgba(37,99,235,0.35)] active:scale-[0.97] transition-all"
        >
          Tambah User
        </button>
...
{successModal && (
  <div className="fixed inset-0 bg-black/20 flex items-center justify-center z-[999]">
    ...
    <div className="w-[420px] bg-white rounded-[16px] p-6 text-center shadow-[0_20px_60px_rgba(0,0,0,0.15)]">
      ...
      <p className="text-[14px] text-gray-400 mb-5">
        Minta pengguna cek email dan<br />
        menambahkan kata sandi akunnya
      </p>
...
<div className="flex flex-col gap-[12px] w-full lg:w-[365px]">
  ...
  <div className="bg-white rounded-[12px] p-[20px] border border-slate-200 flex flex-col gap-[10px]" style={{ height: "427px" }}>
    ...
    <h3 className="text-[14px] font-semibold text-gray-700 text-center">
    ...
    <div className="flex items-center justify-center flex-1">
      <div className="relative">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
          ...
          <p className="text-[12px] text-gray-400 text-center leading-tight mt-[4px]">
  ...
  {/* SMART ALERTS CARD */}
  {/* H total right col = 610, donut = 427, gap = 12 → smart alerts = 610 - 427 - 12 = 171px */}
  <div
    ...
    style={{
      ...
      boxShadow: "0 8px 24px rgba(0,34,255,0.35)",
    }}
  >
    <img
      src={smartIcon}
      className="absolute -top-4 -right-4 w-[184px] opacity-28 pointer-events-none z-0"
    />

    <p className="text-[14px] font-semibold text-white relative z-10">
      Smart Alerts
    </p>
  ...
  return (
    <div className="bg-white rounded-[16px] h-[128px] px-[20px] py-[16px] border border-slate-200 flex flex-col justify-between">
      ...
      <div className="flex justify-between items-start">
        <p className="text-[16px] font-medium text-gray-700 leading-tight">
          {title}
        </p>
